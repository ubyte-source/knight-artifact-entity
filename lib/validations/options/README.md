...
#### ***Class Entity\validations\options\Search usable methods***

##### `public function __construct()`

The constructor is called when the class is instantiated.

The constructor is a special function that is called when a new instance of the class is created.
